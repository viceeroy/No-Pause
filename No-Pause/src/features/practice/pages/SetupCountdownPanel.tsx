        ...
        {state === 'setup' ? (
          <div className="flex min-h-[calc(100dvh-230px)] flex-col items-center justify-between py-1 md:min-h-0 md:justify-start md:gap-8 md:py-0">
            <div
              ...
              aria-label="Topic prompts carousel"
              tabIndex={0}
              className={cn(
            ...
            <div className="flex w-full flex-col items-center gap-4 pb-2 pt-6 md:pt-0 md:pb-0">
              ...
              >
                ...
                <span className="hidden text-xs opacity-70 md:inline font-sans font-medium bg-primary-foreground/20 px-1.5 py-0.5 rounded border border-primary-foreground/30">[Space]</span>
              </button>
            </div>
          </div>
        ) : (
