        ...
        {state === 'setup' ? (
          <div className="flex min-h-[calc(100dvh-230px)] flex-col items-center justify-between py-1 md:min-h-0 md:justify-start md:gap-8 md:py-0">
            ...
            <div className="flex w-full flex-col items-center gap-4 pb-2 pt-6 md:pt-0 md:pb-0">
              ...
              >
                Start Speaking <span className="hidden opacity-70 md:inline"> [Enter]</span>
              </button>
            </div>
          </div>
        ) : (
      ...
      {state === 'countdown' && (
        <div className="pointer-events-none fixed inset-0 z-30 flex items-center justify-center">
          <div
            aria-live="assertive"
            aria-atomic="true"
            className="text-9xl font-serif font-bold text-primary animate-in zoom-in duration-300"
          >
            {countdown}
          </div>
        </div>
