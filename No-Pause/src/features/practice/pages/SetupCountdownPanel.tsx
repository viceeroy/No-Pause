...
export function SetupCountdownPanel({
  ...
  // Global spacebar shortcut to start speaking
  useEffect(() => {
        ...
        {state === 'setup' ? (
          <div className="flex min-h-[calc(100dvh-230px)] flex-col items-center justify-between py-1 md:min-h-0 md:justify-start md:gap-8 md:py-0">
            <div
              ...
              aria-label="Prompt carousel. Use left and right arrow keys to navigate."
              className={cn(
            ...
            <div className="flex w-full flex-col items-center gap-4 pb-2 pt-6 md:pt-0 md:pb-0">
              ...
              >
                Start Speaking <span className="hidden opacity-70 md:inline font-mono text-xs ml-1">[Space]</span>
              </button>
            </div>
          </div>
        ) : (
