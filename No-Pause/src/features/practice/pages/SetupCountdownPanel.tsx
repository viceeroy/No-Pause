        ...
        {state === 'setup' ? (
          <div className="flex min-h-[calc(100dvh-230px)] flex-col items-center justify-between py-1 md:min-h-0 md:justify-start md:gap-8 md:py-0">
            <div
              ...
              aria-label="Practice prompt carousel. Use left and right arrow keys to navigate prompts."
              className={cn(
                'w-full overflow-hidden select-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:rounded-[28px] outline-none',
