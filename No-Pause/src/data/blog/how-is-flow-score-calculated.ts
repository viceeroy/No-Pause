...
export const howIsFlowScoreCalculatedPost: BlogPost = {
  ...
  shortAnswer:
    'For completed scoring modes, Flow Score starts at 100. The first two hesitations are forgiven, and each additional hesitation subtracts 10 points. This makes the formula easy to understand and consistent across sessions. This approach works best when you review the data immediately and apply one correction in the next attempt.',
  sections: [
    {
      heading: 'Core formula',
      content:
        'The score is built to reward continuity while allowing normal speech transitions. You are not punished immediately for small pauses, but repeated hesitation reduces score quickly. Keeping the same session conditions for a few runs gives cleaner feedback and helps you improve more predictably.',
      bullets: [
        'Base score: 100',
        'First 2 hesitations: no penalty',
        'Each extra hesitation: -10',
      ],
    },
    {
