      ...
      >
        ...
        <div style={{ maxWidth: 560, position: "relative", zIndex: 2 }}>
          ...
          <p style={{ margin: 0, color: "rgba(227,236,255,0.9)", fontSize: 21, lineHeight: 1.48, maxWidth: 500 }}>
            Join No Pause to track progress, build streaks, and improve your speaking flow every day.
          </p>
        </div>
      </section>
      ...
      >
        <div style={{ width: "100%", maxWidth: 420 }}>
          <div style={{ marginBottom: 22 }}>
            ...
            <div style={{ marginTop: 7, fontSize: 14, color: "#475569" }}>Create your profile to get started.</div>
          </div>
          ...
          <div style={{ textAlign: "center", padding: "10px 0 4px", fontSize: 14, color: "#475569" }}>
            Already have an account? <Link to="/auth" style={{ color: "#0f172a", fontWeight: 700 }}>Sign in</Link>
          </div>
        </div>
      </section>
    </div>
