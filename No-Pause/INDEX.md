...
| `src/services/aiFeedback.ts` | Gemini-backed AI feedback helpers, transcript usability helper, practice feedback generation | `api/feedback.ts`, `src/lib/telegram/voiceHandler.ts` |
...
| `src/services/gemini.ts` | Gemini 2.5 Flash text generation client | `src/services/aiFeedback.ts` |
