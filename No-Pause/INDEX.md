...
| `src/services/groq.ts` | Groq chat completions text generation client and Whisper transcription helper with word timestamps | `api/transcription.ts`, `src/lib/telegram/voiceHandler.ts`, `src/services/aiFeedback.ts` |
