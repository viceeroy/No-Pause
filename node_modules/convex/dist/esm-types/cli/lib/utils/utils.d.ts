...
import type { paths as CliManagementPaths, TeamResponse } from "../../generatedApi.js";
 ...
 */
export declare function processDeployKeyValue(ctx: Context, deployKey: string | undefined): Promise<string | undefined>;
...
export declare function selectRegionOrUseDefault(ctx: Context, selectedTeam: TeamResponse): Promise<string | null>;
export declare function selectRegion(ctx: Context, teamId: number): Promise<string | null>;
...
export declare const typedBigBrainClient: (ctx: Context, options?: {
    throw?: boolean;
}) => import("openapi-fetch").Client<CliManagementPaths, `${string}/${string}`>;
export declare const typedPlatformClient: (ctx: Context, options?: {
    throw?: boolean;
}) => import("openapi-fetch").Client<PlatformManagementPaths, `${string}/${string}`>;
