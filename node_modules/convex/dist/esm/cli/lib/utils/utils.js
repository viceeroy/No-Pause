...
export async function processDeployKeyValue(ctx, deployKey) {
  if (deployKey === void 0) {
    return void 0;
  }
...
export async function validateOrSelectTeam(ctx, teamSlug, promptMessage) {
  ...
  if (!teamSlug) {
    switch (teams.length) {
      ...
      default: {
        const teamSlug2 = await promptSearch(ctx, {
...
export async function selectRegionOrUseDefault(ctx, selectedTeam) {
...
export async function selectRegion(ctx, teamId) {
